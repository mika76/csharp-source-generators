...
- [Using C# Source Generators to create an external DSL](https://devblogs.microsoft.com/dotnet/using-c-source-generators-to-create-an-external-dsl/) (2021-01-27) This post looks at how to use C# Source Generators to build an external DSL to represent mathematical expressions.
